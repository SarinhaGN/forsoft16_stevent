 ...
 */
@WebServlet("/buscarLocal")
public class ObterPorIdLocalController extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
			...
			Local local = localDao.obter(id);
                        
                        //FALTA VERIFICAR SE LOCAL NÃO É NULO ANTES DE ATRIBUIR
